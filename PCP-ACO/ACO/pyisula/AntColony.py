...
class AntColony(Environment):
    ...
    def getBestPerformingAnt(self, environment):
        ...
        for ant in self.__hive:
            if ant.isSolutionReady(environment) and ant.ant.getSolutionCost(environment) < bestAnt.getSolutionCost(
                    environment):
                bestAnt = ant
    ...
    def shouldTerminateExecution(self, executionStartTime):
        if self.__timeLimit is not None and executionStartTime is not None:
    ...
    def buildSolutions(self, environment, configurationProvider, executionStartTime):
        ...
        for ant in self.__hive:
            ...
            logger.log(logging.DEBUG,
                       "Solution is ready > Cost: {} , Solution: {}".format(ant.getSolutionCost(environment),
